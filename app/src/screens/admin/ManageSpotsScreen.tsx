    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        {isDeveloper ? (
          ...
          >
            <Text style={styles.branchText}>{branchId === "branch_1" ? "시흥본점" : "영종도점"}</Text>
            <Ionicons name="swap-horizontal" size={16} color="#6366F1" style={{ marginLeft: 4 }} />
          </TouchableOpacity>
        ) : (
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: "row", padding: 20, justifyContent: "space-between", alignItems: 'center' },
  title: { fontSize: 18, fontWeight: "bold" },
  branchSwitcher: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#EEF2FF', padding: 8, borderRadius: 12 },
  ...
  spotItem: { flexDirection: "row", justifyContent: "space-between", padding: 20, borderBottomWidth: 1, borderBottomColor: "#eee" },
