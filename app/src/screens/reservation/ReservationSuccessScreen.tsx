...
// 1. 경고 해결을 위해 react-native-safe-area-context에서 가져옵니다
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.buttonGroup}>
        <TouchableOpacity
          ...
          // 2. '바로 수업 예약하기'를 더 강조하기 위해 순서를 바꾸거나
          // navigation 스택 상황에 맞춰 'Reservation'으로 이름을 확인하세요.
...
const styles = StyleSheet.create({
  ...
  // 3. 버튼 디자인 가이드: 결제 완료 후 가장 권장하는 행동을 Primary 색상으로 지정
  primaryButton: {
